...
```
Commentary:
When looking at the age range of 60+ in the high school equivalent category, more females had reached this level of educational attainment than males. In the younger generation of ages 20-40, more individuals including both males and females have attained a level of education that is greater than high school in comparison to education that is less than high school.
...
In all three categories of education, there is a general downward trend between aging and activity. As individuals age, their activity levels decrease. This applies to both men and women, however the smallest rate of change is observed in individuals who have obtained an education level that is more than high school.
...
print(hour_df)
```
In this plot, I can see that both men and females tend to exercise the most mid day in each category. In individuals who obtained education that is greater than high school, many males are more active towards the end of the day in comparison to the other education groups.
